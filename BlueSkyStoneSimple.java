...
// Created  for 16887.
@Autonomous(name="BlueSkyStone Simple", group="Simple")
//@Disabled
public class BlueSkyStoneSimple extends BaseRobot {
    private int stage = 0;
    @Override
    public void init() {
        super.init();
...
//        open_servos();                  // open the left and right servos
    ...
    public void loop() {
        ...
        if (DEBUG) telemetry.addData("Blue Skystone Simple: ", stage);
        super.loop();
    }
}
