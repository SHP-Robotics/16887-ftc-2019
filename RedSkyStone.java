    ...
    public void loop() {
        ...
        switch (stage) {
            case 0:          // SLOWLY Forward 45 inches or touches the skystone
                ...
                if (auto_drive(0.75, 70.0) || touches) {
                    reset_drive_encoders();
                    stage++;
                }
                break;
            case 1:          // SLOWLY Strafe LEFT up to 6 inches until a black skystone is found
                ...
                break;
            case 2:         // CAREFULLY FORWARD 2.0 inch to start grabbing
...
// }
            ...
            case 6:         // Back 20 inches
                ...
                break;
            case 7:         // Move RIGHT 30 inches + distance moved to find the black skystone (or turn right and go straight)
            ...
            case 8:         // Open Servos to drop the skystone
                ...
                break;
            case 9:         // Move LEFT 10 inches and stop on the line
                if (auto_mecanum(-1.0, 60.0)) {    // Strafe LEFT
                    reset_drive_encoders();
