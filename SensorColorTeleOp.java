 ...
 */
@TeleOp(name = "Sensor: Color", group = "_Sensor")
//@Disabled
public class SensorColorTeleOp extends LinearOpMode {
  ...
  protected void runSample() throws InterruptedException {
    ...
    colorSensor = hardwareMap.get(NormalizedColorSensor.class, "sensorColorRange");
