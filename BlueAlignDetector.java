...
public class BlueAlignDetector extends DogeCVDetector {
    ...
    private boolean aligned  = false; // Is the blue mineral aligned
    private double  blueXPos = 0;     // X Position (in pixels) of the blue element
     ...
     * Simple constructor
     */
    public BlueAlignDetector() {
        super();
        detectorName = "Blue Align Detector"; // Set the detector name
    }
    ...
    public Mat process(Mat input) {
        ...
        //Find contours of the blue mask and draw them to the display mat for viewing
        ...
        double xPos; // Current Blue X Pos
        ...
        if(debugAlignment){
            ...
            if(isFound()){
                Imgproc.line(displayMat,new Point(blueXPos, getAdjustedSize().height), new Point(blueXPos, getAdjustedSize().height - 30),new Scalar(300,300,0), 2);
            }
    ...
    /**
     * Set the alignment settings for BlueAlign
    ...
    /**
     * Returns if the blue element is aligned
     * @return if the blue element is alined
     */
    ...
    /**
     * Returns blue element last x-position
     * @return last x-position in screen pixels of blue element
     */
